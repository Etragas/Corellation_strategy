...
if __name__ == '__main__':
    ...
    strats = cerebro.optstrategy(
        ...
        sl_per = -1,
        th_theil_d = 29,
        th_theil_u = range(50, 60, 1),
        th_pear = [33, 30],
        money_k = range(80, 151, 5))
    ...
    for i in range(len(thestrats)):
        print('Sharpe:', thestrats[i][0].analyzers.sharpe.get_analysis(), thestrats[i][0].params.money_k, thestrats[i][0].params.th_theil_d, thestrats[i][0].params.th_theil_u, thestrats[i][0].params.th_pear, thestrats[i][0].params.tp_per)