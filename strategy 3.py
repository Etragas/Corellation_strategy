...
class CorrelationStrategy(bt.Strategy):
    params = (('period',  15), ('th_theil_d', 30), ('th_theil_u', 59), ('th_pear', 50), ('sl_per', -1), ('tp_per', 12), ('sl_k', 85)) # k= tp/sl
    ...
    def stop(self):
        print("Profit:", str(int((self.broker.getvalue() - 500000) // 1000)) + "k")
...
if __name__ == '__main__':
    ...
    print('Sharpe:', thestrats[0].analyzers.sharpe.get_analysis())
    cerebro.plot()
